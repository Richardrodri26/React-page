...
import { AiFillFacebook, AiFillInstagram, AiFillTwitterSquare, AiOutlineWhatsApp, AiFillPhone, AiFillMessage } from 'react-icons/ai';
        ...
        <footer className="w-4/5 m-auto py-10">
            <div className="md:flex md:justify-between sm:grid sm:grid-cols-2 sm:justify-center items-center my-10">
                ...
                <div className="flex flex-col space-y-3">
                    ...
                    <a className="text-xs text-gray-400" href="/">Sing up</a>
                ...
                <div className="flex flex-col space-y-3">
                    <h1 className="font-bold">Downloand</h1>
